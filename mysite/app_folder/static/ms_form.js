...
$(document).ready(function () {
    ...
    var $slider_sheet = $("#female_slider_spreadsheet");
    var $slider_paste = $("#female_slider_paste");
    var validator;
    var animating;
    ...
    $slider_paste.slider({
        ...
        slide: function (event, ui) {
            $("#bool_female_range_unknown_paste").prop("checked", false);
            $("#female_range_paste").val((Math.floor(ui.values[0] * 100)) + "% - " + (Math.floor(ui.values[1] * 100)) + "%");
        }
    });
    ...
    $slider_sheet.slider({
        ...
        values: [.4, .6],
        slide: function (event, ui) {
            $("#bool_female_range_unknown_spreadsheet").prop("checked", false);
            $("#female_range_spreadsheet").val((Math.floor(ui.values[0] * 100)) + "% - " + (Math.floor(ui.values[1] * 100)) + "%");
        }
    });
